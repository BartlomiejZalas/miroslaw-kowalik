    ...
    return (
      <div>
        <p>
          ...
          Dziedzictwa Narodowego – Kultura w sieci. Utwór nosi tytuł "Siódma
          rano", a w tworzeniu go wzięli udział:
        </p>
        <p>
          Wykonawcy:
          <br />
        ...
        <p>
          muzyka - Martyna Bieszczad, Ignacy Wendt, Paweł Kowalik, Mirosław
          Kowalik
          <br />
